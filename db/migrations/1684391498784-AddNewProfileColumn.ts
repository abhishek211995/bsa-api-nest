...
//         await queryRunner.query(`ALTER TABLE \`bre_user\` CHANGE \`user_address\` \`user_address\` varchar(250) NOT NULL DEFAULT ''`);
//     }

//     public async down(queryRunner: QueryRunner): Promise<void> {
//         await queryRunner.query(`ALTER TABLE \`bre_user\` CHANGE \`user_address\` \`user_address\` varchar(250) NOT NULL`);
